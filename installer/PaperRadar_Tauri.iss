...
OutputBaseFilename=PaperRadar_Tauri_Setup_v{#MyAppVersion}
...
[Files]
Source: "..\dist\PaperRadar-Tauri-v0.3.0\PaperRadar.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\dist\PaperRadar-Tauri-v0.3.0\paperradar-backend.exe"; DestDir: "{app}"; Flags: ignoreversion
